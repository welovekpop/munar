/**
 * Stolen from https://github.com/lucjon/unescape/, JavaScript's Only Non-Poopy Unescape "Module"™
 */
var _entities = {
	"&nbsp;": " ",
	"&iexcl;": "¡",
...
export default function unescape2(input) {
	var entityRe = /&(#?)(\d{1,5}|\w{1,8});/g;
